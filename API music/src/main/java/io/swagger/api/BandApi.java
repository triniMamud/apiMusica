...
public interface BandApi {
    ...
    ResponseEntity<Void> addBand(@Parameter(in = ParameterIn.DEFAULT, description = "Band object that needs to be added to the repository", required=true, schema=@Schema()) @Valid @RequestBody Band body);
